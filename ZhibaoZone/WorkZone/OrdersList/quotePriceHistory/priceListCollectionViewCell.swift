...
class priceListCollectionViewCell: UICollectionViewCell {
    lazy var priceCountSequenceValue:UILabel = {
        let tempLabel = UILabel.init(frame: CGRect(x: 5, y: 19, width: 30, height: 15))
        tempLabel.text = "1"
    ...
    lazy var priceValue:UILabel = {
        let tempLabel = UILabel.init(frame: CGRect(x: 5, y: 59, width: 130, height: 15))
        tempLabel.text = "尚未报价"
        tempLabel.textColor = UIColor.titleColors(color: .black)
        tempLabel.textAlignment = .left
        tempLabel.font = UIFont.boldSystemFont(ofSize: 12)
    ...
    lazy var priceTime:UILabel = {
        let tempLabel = UILabel.init(frame: CGRect(x: 5, y: 101, width: 130, height: 15))
        tempLabel.text = "-"
        tempLabel.textColor = UIColor.titleColors(color: .black)
        tempLabel.textAlignment = .left
    ...
    lazy var currentPriceIcon:UIImageView = {
        let tempLabel = UIImageView.init(frame: CGRect(x: 17, y: 19, width: 26, height: 15))
