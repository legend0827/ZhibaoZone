...
class WorkZoneViewController: UIViewController,UITableViewDelegate,UITableViewDataSource,UITextViewDelegate ,UITextFieldDelegate,UIImagePickerControllerDelegate,UINavigationControllerDelegate{
    ...
    var imageURLs:[String] = ["https://mbd.baidu.com/newspage/data/landingsuper?context=%7B%22nid%22%3A%22news_5801023942533165508%22%7D&n_type=0&p_from=1","https://mbd.baidu.com/newspage/data/landingsuper?context=%7B%22nid%22%3A%22news_5801023942533165508%22%7D&n_type=0&p_from=1","https://mbd.baidu.com/newspage/data/landingsuper?context=%7B%22nid%22%3A%22news_5801023942533165508%22%7D&n_type=0&p_from=1"]
    var deadLineInMinsInInt = 0
...
//        //订单输入框判断
//        if orderIDTextField.isFirstResponder && addingFirstWords{
//            orderFieldIsEmpty = false
//        }else{
//            if orderIDTextField.text != ""{
//                orderFieldIsEmpty = false
//            }else{
//                orderFieldIsEmpty = true
//            }
//        }
        //处理期限输入框判断
...
//        greyMask.addGestureRecognizer(gestureRecognizer)
    ...
    func loadNewTaskView(){
        let newTaskViewTitle:UILabel = UILabel.init(frame:CGRect(x: UIScreen.main.bounds.width/2 - 44, y: 13, width: 88, height: 30))
...
//            let newTaskUpdateURL:String = "http://192.168.1.102:8068/task/createTasklist.do"
        ...
        do {
            ...
            for info in fetchedObjects{
                ...
                params["taskimageurl1"] = "imag/login.jpg"
                params["taskimageurl2"] = "imag/login.jpg"
                params["taskimageurl3"] = "imag/login.jpg"
        ...
        let dataRequest = Alamofire.request(newTaskUpdateURL,method:.get, parameters:params as? [String:AnyObject],encoding: URLEncoding.default) .responseJSON{
            (responseObject) in
...
//    }
    ...
    @objc func imageViewTap(_ recognizer:UITapGestureRecognizer){
        ...
        //进入图片全屏展示
        let previewVC = ImagePreviewVC(images: AttachmentPics, index: (index-10))
    ...
    @objc func uploadPicBtnClicked(){
        ...
        let selectPhotos = UIAlertAction(title: "相册选取", style: .default, handler: {
            ...
            _ = self.presentHGImagePicker(maxSelected:allowChooseCount) { (assets) in
                ...
                var LoopCounter = 0
                for asset in assets {
                    let tempImage = self.PHAssetToUIImage(asset: assets[LoopCounter])
                    LoopCounter += 1
                    self.AttachmentPics.append(tempImage)
                    print(asset)
                }
                
                self.attachmentPicCount += assets.count
...
//        })
    ...
    func imagePickerController(_ picker: UIImagePickerController, didFinishPickingMediaWithInfo info: [String : Any]) {
        ...
        if type == "public.image"
        {
            ...
            let imagePath = documentPath.appending("/image.png")
